...
class CompletionSupervisorTests(unittest.TestCase):
    ...
    def _open_build(self, build_id=None):
        ...
        # legacy/non-mechanical setup explicit: the mechanical path itself is
        # covered by BuildStateTests and may only move through its authoritative
        # claim, writer, check, review, gate, and finalize operations.
